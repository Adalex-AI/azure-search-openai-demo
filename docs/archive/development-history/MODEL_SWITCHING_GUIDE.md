...
3. **Proven compatibility**: All evaluation scripts and metrics work reliably
4. **Faster responses**: No additional reasoning overhead
...
2. Check the [supported regions](https://learn.microsoft.com/azure/ai-services/openai/concepts/models#standard-deployment-model-availability)
3. Review the [GPT-5-nano constraints](#gpt-5-nano-constraints) below
...
2. You have resolved all backend compatibility issues
3. You have budget for higher token costs
...
3. **Review logs** for parameter errors or timeouts

4. **Temporary workaround**: Switch back to GPT-4.1-mini
...
3. Confirm the deployment name matches your environment variable
4. Check the deployment status is "Succeeded" and quota is available
