...
class RetrieveThenReadApproach(Approach):
    ...
    def get_citation_from_document(self, doc: Document) -> str:
        """Get citation string from document - delegates to customizations module"""
        return citation_builder.build_enhanced_citation(doc, 1)
    ...
    def get_citation_from_document_dict(self, doc_dict: dict[str, Any]) -> str:
        """Get citation string from document dict - delegates to customizations module"""
