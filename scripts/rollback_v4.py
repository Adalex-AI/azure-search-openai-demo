...
def build_rollback_plan(
    ...
    rollback_agentic_mode = targets.get("rollback_agentic_mode", "agentic")
    if current_release_id is not None and rollback_release_id == current_release_id:
        raise RollbackError("Rollback evidence must identify a previous release")
    ...
    return {
        ...
        "agentic_mode": rollback_agentic_mode,
